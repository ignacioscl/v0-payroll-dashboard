...
export const SrsPhpPath = {
  ...
  INVOICE_EMAIL_QUEUE_ADD: 'php/api/payroll/invoice-email-queue-add.php',
  INVOICE_STATEMENT_DELETE: 'php/api/payroll/invoice-statement-delete.php',
  INVOICE_STATEMENT_DISCOUNT: 'php/api/payroll/invoice-statement-discount.php',
  INVOICE_STATEMENT_PO_RO: 'php/api/payroll/invoice-statement-po-ro.php',
  INVOICE_STATEMENT_REMOVE_WO: 'php/api/payroll/invoice-statement-remove-wo.php',
  INVOICE_STATEMENT_NOTES: 'php/api/payroll/invoice-statement-notes.php',
  ...
  INVOICE_TTK_DETAIL: 'php/api/payroll/invoice-ttk-detail.php',
  INVOICE_EXPORT: 'php/api/payroll/invoice-export.php',
